...
public class DAOFactory {
    ...
    private static final String FICHIER_PROPERTIES       = "/fr/commerce/dao/dao.properties";
    ...
    public static DAOFactory getInstance() throws DAOConfigurationException {
        ...
        try {
            ...
            if ( fichierProperties == null ) {
                throw new DAOConfigurationException( "Le fichier properties " + FICHIER_PROPERTIES
                        + " est introuvable." );
            }
        }
